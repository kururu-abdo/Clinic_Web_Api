namespace clinic.Utils
{
    public static class PaymentConfiguration
    {
        ...
        public const string AuthorisedUrl = "https://yourwbsitedomain/payment/success";
        public const string DeclinedUrl = "https://yourwebsitedomain/payment/decline";
        public const string CancelledUrl = "https://yourwebsitedomain/payment/canceled";
